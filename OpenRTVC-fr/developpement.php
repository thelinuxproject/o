...
<style type="text/css">
	...
	<section>
		...
		<article id="SYST-PARA">
			...
			<div class="box-2">
				<a href="shop.php"><img class="img-visible" src="../image/OpenRTVC-PCB.jpg" width="200px" align="right"></a>
				<a href="shop.php"><img class="img-visible" src="../image/Plan-OpenRTVC-PCB.jpg" width="175px" align="right"></a>
				<h3>Matériel électronique:</h3>
				<ul>
					<li>PCB(OpenRTVC)</li>
				</ul>
