	...
	<section>
		...
		<article>
			...
			<div class="folio">
				<div class="chapitre-folio">
					<a href="developpement.php#TVC-V2" class="a-img-text">
				...
				<div class="chapitre-folio">
					<a href="developpement.php#TVC-V1" class="a-img-text">
		...
		<article>
			...
			<div class="article">
				...
				<p>
					Plus d’informations relatives au montage dans la partie<a href="developpement.php"> développement</a>.
				</p>
			</div>
		</article>
		<article>
			...
			<div class="article info">
				<p>
					Tous les travaux d'OpenRTVC sont sous <a href="apropos.php#MIT">Licence MIT</a>.
				</p>
				<p>
					Si vous voulez construire votre TVC de A à Z vous retrouverez la liste de tout les composant mecanique et electronique dans la partie<a href="developpement.php"> developpement </a>Ainsi que toute la documentation nécessaire à la fabrication.<br>
					Et pour les plus impatient d'entre vous voici quelques <a href="shop.php">kits OpenRTVC</a><br>
